...
in
{
  ...
  services.transmission = {
    enable = true;
    openFirewall = true; # Opens port 51413 for peer-to-peer
    openRPCPort = true;  # Opens port 9091 for web interface
    user = "rileytuttle";
    settings = {
      download-dir = "/home/rileytuttle/Downloads";
      incomplete-dir = "/home/rileytuttle/.transmission-incomplete";
      incomplete-dir-enabled = true;
      rpc-enabled = true;
      rpc-bind-address = "127.0.0.1";   # or 127.0.0.1 if local only
